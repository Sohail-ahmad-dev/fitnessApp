                            ...
                            <div class="post-item wow" data-animation="fadeInUp" data-animation-delay="300">
                                ...
                                <div class="post wow fadeInUp">
                                    ...
                                    @if ($blog->post_type == 'image')
                                        <a href="blog-detail.html"><img class="img-responsive"
                                                src="{{ !empty(asset('public/upload/images/' . $blog->post_url)) ? asset('public/upload/images/' . $blog->post_url) : 'N/A' }}"
                                                alt="{{ $blog->post_title }}" alt="{{ $blog->post_title }}" /></a>
                                    @else
                                    ...
                                    <div class="post-content">
                                        ...
                                        <!-- Meta -->
                                        <div class="posted-date">July 19, 2014 / <span>by</span> <a href="#">John</a>
