                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <img class="profile_img"
                                            src="{{ asset('public/upload/images/' . Auth::user()->image) }}"
                                            alt="{{ Auth::user()->name }}">
                                    </li>
                                    <li class="list-group-item"><i class="fa fa-user"></i> {{ Auth::user()->first_name }}
                                        {{ Auth::user()->last_name }}</li>
                                    <li class="list-group-item"><i class="fa fa-envelope"></i> {{ Auth::user()->email }}
                                    </li>
                                    <li class="list-group-item"><i class="fa fa-map-marker"></i> {{ Auth::user()->address }}
                                    </li>
