                                ...
                                <tbody>
                                   ...
                                   @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <img class="profile_img" src="{{ !empty (asset('upload/images/'. $item->equipment_img)) ? asset('upload/images/'. $item->equipment_img) :  "N/A"}}" alt="{{ $item->title}}">
                                            </td>
                                           <td>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="deleteEquipment({{ $item->id }})">Delete</button>
                                                <a href="{{ url('equipment/'.$item->id.'/edit') }}" class="btn btn-primary btn-sm">Update</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
