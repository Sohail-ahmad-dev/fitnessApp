                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->upload_type == "image")
                                                    <img class="profile_img" src="{{ !empty (asset('upload/images/'. $item->workout_url)) ? asset('upload/images/'. $item->workout_url) :  "N/A"}}" alt="{{ $item->post_title}}">
                                                @else
                                                    <video width="100" height="100" controls>
                                                        <source src="{{ !empty (asset('upload/images/'. $item->workout_url)) ? asset('upload/images/'. $item->workout_url) :  "N/A"}}">
                                                    </video>
                                                @endif
                                            </td>
                                            <td class="postDesc">
                                           ...
                                           <td>
                                            <button type="button" class="btn btn-danger" onclick="deleteWorkout({{ $item->id }})">Delete</button>
                                            <a href="{{ url('guided-workouts/'.$item->id.'/edit') }}" class="btn btn-primary">Update</a>
                                           </td>
                                        </tr>
                                        @endforeach
                                        @endif
