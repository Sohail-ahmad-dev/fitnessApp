                                            ...
                                            <tr>
                                                <td>
                                                    <img class="profile_img"
                                                        src="{{ !empty(asset('public/upload/images/' . $user->image)) ? asset('public/upload/images/' . $user->image) : 'N/A' }}"
                                                        alt="{{ $user->first_name }}">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <select
                                                        class="user_status form-control {{ $user->status == '1' ? 'text-succes' : 'text-dnger' }}"
                                                        id="userStatus-{{ $user->id }}"
                                                        data-userId="{{ $user->id }}"
                                                        onchange="stateUpdateUser({{ $user->id }})">
                                                        <option value="1"
                                                            {{ $user->status == '1' ? 'selected' : '' }}>Active</option>
                                                        <option value="0"
                                                            {{ $user->status == '0' ? 'selected' : '' }}>In Active</option>
                                                    </select>
                                                </td>
                                                <td>
